...
const ARTICLES: Record<string, OliveYoungArticleSpec> = {
  ...
  "korean-serum-brightening-ranking-compare": {
    ...
    intro:
      "くすみや色ムラ、跡やキメが気になる肌へ、韓国で人気の美容液（セラム）をランキング観点から一覧します。オリーブヤングの公式ランキングを根拠にした比較記事で、順位は取得時点のものです。効果感には個人差があります。本記事では同カテゴリ内の別候補も比較対象として掲載しています。",
    limit: 10,
    themeMatchKeywords: [
      "透明",
      "トーン",
  ...
  "korean-cream-night-ranking-compare": {
    ...
    title:
      "韓国クリーム（鎮静・敏感肌・肌荒れケア）おすすめ｜Olive Youngランキング比較",
    description:
      "シカ・スージング系など、落ち着いたケア向けの韓国クリームをオリーブヤング売れ筋ランキングから比較。夜の保湿や肌状態に合わせた候補を、詳細ページとショップリンクから確認できます。",
    intro:
      "夜の保湿や、敏感になりやすい肌・肌荒れが気になる方向けに、韓国オリーブヤングのランキングに載るクリームのうち、鎮静・リペア寄りの訴求が見られる商品を中心に比較します。ナイト専用の名称がない商品も含まれる場合があります。ランキング順はデータ取得日基準です。脂性肌の方はテクスチャの重さにも注意して選ぶとよいです。",
    limit: 10,
    themeMatchKeywords: [
      "シカ",
      "cica",
